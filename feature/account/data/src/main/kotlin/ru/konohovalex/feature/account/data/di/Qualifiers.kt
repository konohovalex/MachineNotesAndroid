...
internal object Qualifiers {
    ...
    const val PROFILE_DATA_STORE_COROUTINE_SCOPE_PROVIDER = "ProfileDataStoreCoroutineScopeProvider"
    const val PROFILE_DATA_STORE_COROUTINE_SCOPE = "ProfileDataStoreCoroutineScope"
}
